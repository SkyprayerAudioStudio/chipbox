        ...
        if (inst >> 25 == 0x25) /* is a VU instruction */
        {
            ...
            switch (op) {
                ...
                case 000: /* SPECIAL */
                    switch (inst % 64) {
                        ...
                        case 052: /* SLT */
                            ...
                            CONTINUE
                        case 053: /* SLTU */
                            state->SR[rd] = ((unsigned) (state->SR[rs]) <
                                             (unsigned) (state->SR[rt]));
                            state->SR[0] = 0x00000000;
                            CONTINUE
                        default:
                            res_S(state);
                ...
                case 002: /* J */
                    ...
                    JUMP
                case 004: /* BEQ */
                    if (!(state->SR[base] == state->SR[rt])) CONTINUE
                    set_PC(state, PC + 4 * inst + SLOT_OFF);
                    JUMP
                case 005: /* BNE */
                    if (!(state->SR[base] != state->SR[rt])) CONTINUE
                    ...
                    JUMP
                case 006: /* BLEZ */
                    if (!((signed) state->SR[base] <= 0x00000000)) CONTINUE
                    set_PC(state, PC + 4 * inst + SLOT_OFF);
                    JUMP
                case 007: /* BGTZ */
                    if (!((signed) state->SR[base] > 0x00000000)) CONTINUE
